...
Run this on BOTH vehicles before M2. Ten minutes per car with a cheap ELM327 — you do
not need the MCP2515 hardware to have arrived. The answer decides whether diagnostic #1
(oil pressure) is implementable at all, and that is the project's named risk.
...
def main() -> int:
    ...
    print("  Any $12 ELM327 + a terminal: ATZ, ATSP0, then 0100 / 0120 / 0140.",
          file=sys.stderr)
